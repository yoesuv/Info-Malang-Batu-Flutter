    ...
    return InkWell(
        ...
        child: Stack(children: <Widget>[
          ...
          Container(
              ...
              child: Column(
                  mainAxisAlignment: MainAxisAlignment.end, crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[textTitle(), textSubTitle()]))
        ]));
  }
  ...
  Widget textTitle() {
    return Text(itemPlaceModel?.nama ?? '',
        style: TextStyle(
            ...
            fontSize: 18.0,
            shadows: <Shadow>[Shadow(color: Colors.black, offset: const Offset(1.0, 1.0), blurRadius: 2.0)]));
  }

  Widget textSubTitle() {
    return Text(itemPlaceModel?.lokasi ?? '',
        style: TextStyle(color: Colors.white, fontSize: 16.0, shadows: <Shadow>[Shadow(color: Colors.black, offset: const Offset(1.0, 1.0), blurRadius: 2.0)]));
  }
}
