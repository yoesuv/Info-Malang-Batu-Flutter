  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Container(
          ...
          child: Text('Info Malang Batu', style: TextStyle(fontSize: 24.0, fontWeight: FontWeight.bold, fontFamily: 'Pacifico'))),
      Text('Versi $appVersion', style: const TextStyle(fontSize: 14.0)),
      Container(
          padding: EdgeInsets.only(top: itemChangelogPadding, bottom: itemChangelogPadding),
          child: Text('Flutter Version', style: TextStyle(fontSize: 14.0, fontWeight: FontWeight.bold))),
      const Divider(),
      Container(
