        ...
        body: Column(
          ...
          children: <Widget>[
            ...
            Container(
                ...
                child: Text(itemPlaceModel?.nama ?? '', style: const TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold), textAlign: TextAlign.start)),
            Container(
                padding: const EdgeInsets.only(left: 8.0, right: 8.0),
                child: Text(itemPlaceModel?.deskripsi ?? '', style: const TextStyle(fontSize: 14.0), textAlign: TextAlign.start))
          ],
        ));
  }
}
