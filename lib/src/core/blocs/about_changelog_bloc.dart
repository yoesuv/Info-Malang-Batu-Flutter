...
class AboutChangelogBloc
    extends Bloc<AboutChangelogEvent, AboutChangelogState> {
  AboutChangelogBloc() : super(const AboutChangelogState()) {
    on<AboutChangelogEventInit>(_initListChangelog);
  }

  void _initListChangelog(
    AboutChangelogEventInit event,
    Emitter<AboutChangelogState> emit,
  ) {
    final listChangelog = [
      ItemChangelogModel(
        version: 'Versi 2.0.7',
